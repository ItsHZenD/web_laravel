...
<head>
    ...
    @stack('css')
    <script src="{{ asset('js/42d5adcbca.js') }}" crossorigin="anonymous"></script>

    <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
    <link id="pagestyle" href="{{ asset('css/material-dashboard.min.css?v=3.0.5') }}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <script defer src="{{ asset('js/vaafb692b2aea4879b33c060e79fe94621666317369993.js') }}"
        integrity="sha512-0ahDYl866UMhKuYcW078ScMalXqtFJggm7TmlUtp0UlD4eQk0Ixfnm5ykXKvGJNFjLMoortdseTfsRT8oCfgGA=="
        data-cf-beacon='{"rayId":"76f06b26ef83a3d0","version":"2022.11.3","r":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}'
